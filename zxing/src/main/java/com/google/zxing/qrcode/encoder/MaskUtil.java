...
//import "C:\Users\野村　知也\Desktop\pleiades\workspace\Hello\src\com\rs\GF.java"
...
final class MaskUtil {
   ...
   */
  static int countBlank(ByteMatrix matrix) {
   ...
   * same color and give
   * penalty to them. This is actually equivalent to the spec's rule, which is to
   * find MxN blocks and give a
   ...
   * 1:1:3:1:1:4
   * starting with black, or 4:1:1:3:1:1 starting with white, and give penalty to
   * them. If we
