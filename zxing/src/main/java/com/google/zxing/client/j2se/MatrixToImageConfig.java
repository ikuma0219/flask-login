...
public final class MatrixToImageConfig {
  ...
  public static final int BLACK = 0xFF000000;// 画素値？
   ...
   */
  public MatrixToImageConfig(int onColor, int offColor, int errorColor) {
